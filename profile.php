	...
	$user['g_moderator'] == '1'))))																// or the user is another mod
{
	...
	extract( $oeag->oeag_prof_reg_sex_view() );
	...
	extract( $oeag->oeag_prof_reg_birthdate_view() );
...
<?php endif; ?>
<?php $oeag->oeag_prof_reg_sex_form(); ?>
							<br />
<?php $oeag->oeag_prof_reg_birthdate_form(); ?>
						</div>
					</fieldset>
				</div>
				<p class="buttons"><input type="submit" name="update" value="<?php echo $lang_common['Submit'] ?>" /> <?php echo $lang_profile['Instructions'] ?></p>
