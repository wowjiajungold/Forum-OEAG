	...
	<form method="post" id="post" action="pms_send.php" onsubmit="return process_form(this)">
		...
		<fieldset>
			...
			<div class="infldset txtarea">
				...
				<textarea id="req_message" name="req_message" rows="20" cols="95" tabindex="<?php echo $cur_index++ ?>"><?php echo ($p_message != '' ? pun_htmlspecialchars($p_message) : ''); ?></textarea><br /></label>
