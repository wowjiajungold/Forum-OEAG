...
if (isset($_POST['form_sent']))
{
	...
	$form = array(
		...
		'signatures'			=> $_POST['form']['signatures'] != '1' ? '0' : '1',
		'sig_img_width'			=> (intval($_POST['form']['signatures_width']) > 0) ? intval($_POST['form']['signatures_height']) : 1,
		'sig_img_height'		=> (intval($_POST['form']['signatures_height']) > 0) ? intval($_POST['form']['signatures_height']) : 1,
		'sig_img_size'			=> (intval($_POST['form']['signatures_size']) > 0) ? intval($_POST['form']['signatures_size']) : 1,
					...
					<fieldset>
						...
						<div class="infldset">
							<table class="aligntop" cellspacing="0">
                                ...
                                <tr>
                                    <th scope="row"><?php echo $lang_admin_options['Last visit label'] ?></th>
                                    <td>
                                        <input type="radio" name="form[show_last_visit]" value="1"<?php if ($pun_config['o_show_last_visit'] == '1') echo ' checked="checked"' ?> />&#160;<strong><?php echo $lang_admin_common['Yes'] ?></strong>&#160;&#160;&#160;<input type="radio" name="form[show_last_visit]" value="0"<?php if ($pun_config['o_show_last_visit'] == '0') echo ' checked="checked"' ?> />&#160;<strong><?php echo $lang_admin_common['No'] ?></strong>
                                        <span><?php echo $lang_admin_options['Last visit help'] ?></span>
                                    </td>
                                </tr>
								<tr>
...
<?php $smtp_pass = !empty($pun_config['o_smtp_pass']) ? random_key(pun_strlen($pun_config['o_smtp_pass']), true) : ''; ?>
                ...
                <div class="inform">
                    <fieldset>
                        <legend><?php echo $lang_admin_options['Captcha subhead'] ?></legend>
                        <div class="infldset">
                            <table class="aligntop" cellspacing="0">
                                <tr>
                                    <th scope="row"><?php echo $lang_admin_options['Captcha registration label'] ?></th>
                                    <td>
                                        <input type="radio" name="form[captcha_use_registration]" value="1"<?php if ($pun_config['o_captcha_use_registration'] == '1') echo ' checked="checked"' ?> />&#160;<strong><?php echo $lang_admin_common['Yes'] ?></strong>&#160;&#160;&#160;<input type="radio" name="form[captcha_use_registration]" value="0"<?php if ($pun_config['o_captcha_use_registration'] == '0') echo ' checked="checked"' ?> />&#160;<strong><?php echo $lang_admin_common['No'] ?></strong>
                                        <span><?php echo $lang_admin_options['Captcha registration help'] ?></span>
                                    </td>
                                </tr>
                                <tr>
                                    <th scope="row"><?php echo $lang_admin_options['Public key label'] ?></th>
                                    <td>
                                        <input type="text" name="form[captcha_key_public]" size="50" maxlength="80" value="<?php echo pun_htmlspecialchars($pun_config['o_captcha_key_public']) ?>" />
                                        <span><?php echo $lang_admin_options['Public key help'] ?></span>
                                    </td>
                                </tr>
                                <tr>
                                    <th scope="row"><?php echo $lang_admin_options['Private key label'] ?></th>
                                    <td>
                                        <input type="text" name="form[captcha_key_private]" size="50" maxlength="80" value="<?php echo pun_htmlspecialchars($pun_config['o_captcha_key_private']) ?>" />
                                        <span><?php echo $lang_admin_options['Private key help'] ?></span>
                                    </td>
                                </tr>
                            </table>
                        </div>
