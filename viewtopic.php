...
<?= (count($user_contacts) && !$offmember) ? "\t\t\t\t\t\t".'<dd class="usercontacts">'.implode(' ', $user_contacts).'</dd>'."\n" :'' ;// '<dd class="usercontacts"><em>l\'auteur de ce message n\'est plus présent sur le forum</em></dd>'; ?>
					</dl>
				</div>
				<div class="postright">
...
<?php endif; ?>                     <label><textarea id="req_message" name="req_message" rows="7" cols="75" tabindex="1"></textarea></label>
<?php /* FluxToolBar */
