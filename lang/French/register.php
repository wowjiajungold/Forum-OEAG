...
'Desc 3'      =>  '<b>Si vous étiez déjà inscrit sur l\'ancien forum <a href="http://onenagros.free.fr">On en a gros</a>, <span style="color:blue;">vous devez impérativement utiliser la même adresse email</span></b>. C\'est une mesure de sécurité afin d\'empêcher le dédoublement de comptes ; tous les messages de l\'ancien forum sont affichés au nom de leur auteur de l\'époque, il serait donc problématique que de nouveaux utilisateurs se retrouvent liés à des messages qu\'ils n\'ont jamais posté...<br />Si vous avez oublié, perdu ou changé l\'adresse que vous aviez utilisé à l\'époque, merci de nous contacter pour que nous puissions vous aider.<br /><br /><u>Pour les personnes utilisant une adresse hotmail, live, yahoo, sfr et autres du genre</u>, pensez à vérifier dans vos dossiers spam que le mail de confirmation n\'y soit pas tombé.',
