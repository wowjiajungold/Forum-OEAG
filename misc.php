...
if ($action == 'rules')
{
    ...
    $rules_text = str_replace("<signature_image_size>", ($pun_config['o_sig_img_size']/1000), $rules_text);
    $rules_text = str_replace("<avatars_height>", $pun_config['o_avatars_height'], $rules_text);
