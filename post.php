...
{
?>
<div id="postrevision" class="blockform">
    <h2><span><?php echo $lang_post['Post revision'] ?></span></h2>
    <div class="box">
        <div class="inform">
            <p style="padding: 40px 0 0 10px;"><?php echo $lang_post['Post revision info'] ?></p>
        </div>
    </div>
</div>
<br />
