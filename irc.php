...
?>
                <div id="msg" class="block">
                  <iframe src="https://kiwiirc.com/client/irc.langochat.net/?nick=<?php echo $nick; ?>|?#OnEnAGros" style="border:0; width:100%; height:450px;" width="100%" height="500" frameborder="0" border="0" scrolling="NO" scrollbar="NO"></iframe>
                </div>
<?php
