...
if (isset($_POST['form_sent']))
{
    ...
    if ($pun_config['o_captcha_use_registration'] == '1')
    {
        $result = recaptcha_check_answer($pun_config['o_captcha_key_private'], get_remote_address(), $_POST['recaptcha_challenge_field'], $_POST['recaptcha_response_field']);
        if (!$result->is_valid)
            ...
            <div class="inform">
                <fieldset>
                    ...
                    <div class="infldset">
                        ...
                        <div class="rbox">
<!-- start recaptcha -->
<?= recaptcha_get_html($pun_config['o_captcha_key_public'])."\n"; ?>
<!-- end recaptcha -->
                        </div>
                    </div>
                </fieldset>
